CREATE SCHEMA marketlydb;
USE marketlydb;

-- Insert data into account
INSERT INTO account (auth_type, status, type, username) VALUES 
('OAuth', b'1', 'Admin', 'admin1'),
('OAuth', b'1', 'Admin', 'admin2'),
('Basic', b'1', 'Client', 'client1'),
('Basic', b'1', 'Client', 'client2'),
('Basic', b'1', 'Vendor', 'vendor1'),
('Basic', b'1', 'Vendor', 'vendor2'),
('OAuth', b'0', 'Client', 'client3'),
('OAuth', b'1', 'Client', 'client4'),
('Basic', b'1', 'Admin', 'admin3'),
('OAuth', b'1', 'Vendor', 'vendor3');
